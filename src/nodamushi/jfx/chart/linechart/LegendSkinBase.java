...
public class LegendSkinBase extends TilePane implements Skin<Legend>{
  ...
  private ChangeListener<ObservableList<LineChartData>> changelistener =
      new ChangeListener<ObservableList<LineChartData>>(){
    @Override
    public void changed(
        final ObservableValue<? extends ObservableList<LineChartData>> a ,
            final ObservableList<LineChartData> o ,final ObservableList<LineChartData> n){
      if(o!=null){
  ...
  private ListChangeListener<LineChartData> listener = new ListChangeListener<LineChartData>(){
    ...
    public void onChanged(
        final Change<? extends LineChartData> c){
      while(c.next()){
  ...
  protected void makeChildren(
      final ObservableList<LineChartData> datas,
